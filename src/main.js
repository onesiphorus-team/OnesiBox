...
const SECURITY_HEADERS = {
  ...
  'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data:; connect-src 'self' https://b.jw-cdn.org https://*.jw-cdn.org; media-src 'self' https://*.jw-cdn.org https://cfp2.jw-cdn.org"
};
